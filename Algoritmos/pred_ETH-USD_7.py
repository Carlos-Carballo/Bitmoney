...
color = {0 : '#FED000',1 : 'red',2 : 'green'}

#fig, ax = plt.subplots()
#for name, group in groups:
#    if(name == 'Cluster 0'):
#        ax.plot(group.x, group.y, marker='o', linestyle='', ms=5, label='Incertidumbre', color = '#FED000')
#    elif(name == 'Cluster 1'):
#        ax.plot(group.x, group.y, marker='o', linestyle='', ms=5, label='Vende', color = 'red') ##FED000
#    elif(name == 'Cluster 2'):
...
model = tf.keras.models.load_model('CNN_ETH-USD_7.h5')
model.summary()
imagen = img()
...
print("\033[1m {} \033[0m con 91% de exactitud.".format(etiqueta[pos[np.argmax(score)]]))
